...
const Index = ({
                   residentTypes = [], countryList = [], regions = [], getPersonInfo = () => {
    }, lifeDamage = [], setLifeDamage, title = 'Добавление информации о вреде жизни'
               }) => {
    ...
    return (
        <>
            <Row gutter={16} align="middle">
                <Col span={20}>
                    <Divider className={'mt-0'} orientation={'left'}>{t(title)}</Divider>
                </Col>
